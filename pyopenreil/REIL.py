    ...
    def _process_bb(self, bb, state, dfg, from_insn = False):
        ...
        for insn in bb:            
            ...
            if insn.has_flag(IOPT_CALL):
                ...
                #
                dst = self.arch.Registers.general
                
                # For indirect jumps, 'src' is a temporary register which resolves to the jump location.
                # so, there should be an incoming edge for this temporay register.
                # for direct jumps, 'src' is empty.
                src = tuple(src) + dst
